...
let simpsons = [
    {
        ...
        surname: 'Simpson',
        age: 10,
        info: 'Бартолом\'ю ДжоДжо «Барт» Сімпсон (англ. Bartholomew JoJo «Bart» Simpson) — ' +
            'один із головних героїв мультиплікаційного серіалу Сімпсони. Барт — найстарша дитина Гомера і Мардж Сімпсон. ' +
    ...
    },
    {
        ...
        info: 'Ма́рджори Жакли́н «Мардж» Си́мпсон (в девичестве Бувье́) (англ. Marjorie Jacqueline «Marge» Simpson) — ' +
            ...
            'Обычно носит зелёное платье, красные балетки, на шее — ожерелье из искусственного жемчуга и ездит на оранжевом универсале. ' +
            'У неё шикарные синие волосы, которые она обычно собирает в очень высокую причёску. Глаза цвета ореха (19s6e). ' +
    ...
    },
    {
        ...
        info: 'Ли́за Мари́ Си́мпсон (англ. Lisa Marie Simpson) — героиня мультипликационного сериала «Симпсоны». ' +
            'Средний ребёнок в семье, восьмилетняя девочка, выделяющаяся среди остальных ' +
    ...
    },
    {
        ...
        surname: 'Simpson',
        age: 1,
        info: 'Ма́ргарет Эвелин «Мэ́гги» Си́мпсон (англ. Margaret Evelyn “Maggie” Simpson) — ' +
            'персонаж мультсериала «Симпсоны». Впервые появилась на телевидении в шоу Трейси Ульман, ' +
            'в короткометражке Good Night (англ.)русск. 19 апреля 1987 года. ' +
            'Мэгги была придумана и разработана карикатуристом Мэттом Грейнингом, пока он ждал встречи с Джеймсом Л. Бруксом. ' +
            'Названа в честь младшей сестры Грейнинга. После появления в шоу Трейси Ульман, ' +
            'через три года семья Симпсонов получила собственный сериал на телеканале Fox, дебют произошёл 17 декабря 1989 года.',
...
for (const simpson of simpsons) {
    ...
    for (const key in simpson) {
        ...
        characteristic.innerText = simpson[key];
    }
}
*/
...
for (const course of coursesArray) {
    ...
    tittleDiv.innerText = course.title;
    ...
    courseDiv.append(tittleDiv, durationDiv, list);

    //styles
    document.body.style.display = 'flex';
    document.body.style.flexDirection = 'column';
    document.body.style.alignItems = 'center';
    document.body.style.rowGap = '40px'

    courseDiv.style.height = '370px';
    courseDiv.style.width = '700px'
    ...
    courseDiv.style.border = '3px solid darkBlue'

    tittleDiv.style.border = '2px solid darkblue';
    tittleDiv.style.padding = '10px';

    durationDiv.style.display = 'flex';
    durationDiv.style.justifyContent = 'space-between';

    monthDurationDiv.style.border = '2px solid darkblue';
    monthDurationDiv.style.padding = '10px';
    monthDurationDiv.style.width = '30%'

    hourDurationDiv.style.border = '2px solid darkblue';
    hourDurationDiv.style.padding = '10px'
    hourDurationDiv.style.width = '60%'

    list.style.margin = '0';
    list.style.border = '2px solid darkblue';
    list.style.padding = '10px 40px'
}
*/
